    ...
    return (
      <div className="App">
        <div className="mainBanner"></div>
          ...
          <div className="center-align scrollspy" id="characters">
          ...
          <div className="container">
              <div className="wow fadeInLeft col s12 center-align scrollspy" id="history">
                  ...
                  <p>
                      <a className="waves-effect waves-light btn modal-trigger pink lighten-2 " href="#moreHistory">Learn More</a>
                      <a className="waves-effect waves-light btn modal-trigger pink lighten-2" href="#gameModal">Games</a>
                  </p>
              </div>
          ...
          <div className="parallax-container">
              <div className="parallax"><img src="images/artbay.png" /></div>
          </div>
          ...
          <div className="center-align" id="art">
