            ...
            <div className="z-depth-3 community col s12">
                ...
                <div className="col l9 m9 s12 left-align">
                    ...
                    <p>
                        ...
                        <span className="timeAgo"><Moment unix fromNow>{this.props.time}</Moment></span>
                        <a className="fullArticle" href={"https://reddit.com/" + this.props.permalink} target="_blank">View Full</a>
                    </p>
